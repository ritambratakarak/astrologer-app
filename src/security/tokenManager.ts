...
const secureStorage = new MMKV({id: 'astro-auth-store'});
...
export const tokenManager = {
  ...
  clearAll(): void {
    secureStorage.delete(TOKEN_KEYS.ACCESS);
    secureStorage.delete(TOKEN_KEYS.REFRESH);
    secureStorage.delete(TOKEN_KEYS.ROLE);
    secureStorage.delete(TOKEN_KEYS.USER_ID);
  },
